...
class ManagerClient:
	...
	def fetch_fe_data(self, type: str):
		...
		Args:
		        type (str): The type of agent ("trading" or "affiliate_promoter")
		...
		fe_data = (
			...
			if type == "trading"
			else FE_DATA_AFFILIATE_PROMOTER_DEFAULTS.copy()
		)
		...
		try:
			...
			if type == "trading":
				...
				default_prompts = AffiliatePromoterPromptGenerator.get_default_prompts()
