...
INSERT OR IGNORE INTO sup_agents (
    ...
    'default_affiliate_promoter',
    'default_affiliate_promoter',
    'Default Affiliate Promoter Agent',
    '{}',
    NULL,
    NULL
);
...
INSERT OR IGNORE INTO sup_agent_sessions (
    ...
    CURRENT_TIMESTAMP,
    NULL,
    '{"type":"affiliate_promoter","model":"gemini","mode":"default","role":"terse, funny, curious, philosophical","network":"eth", "time":"24h", "research_tools":["Twitter"],"trading_instruments":["spot"],"metric_name":"followers","notifications":"twitter", "twitter_access_token": "", "twitter_refresh_token": ""}',
    0,
    0,
    900,
    datetime('now', '+12 hours'),
