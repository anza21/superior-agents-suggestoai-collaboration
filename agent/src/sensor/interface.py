...
class AffiliatePromoterSensorInterface:
	"""
	Interface for any AffiliatePromoterSensor that provides Twitter-based affiliate promotion metrics.
	"""
	...
	def get_metric_fn(self, metric_name: str = "followers") -> Callable[[], int]:
		"""
		Returns a callable that fetches a specific affiliate promotion metric.
		"""
		...
